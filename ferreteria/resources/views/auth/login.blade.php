<x-guest-layout>
    <head>
        ...
        <style>
            /* Ocultar ícono nativo de mostrar contraseña */
    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100 overflow-y-auto">
        <div class="bg-white shadow-lg rounded-xl p-10 w-full max-w-md text-center">
            ...
            <!-- Formulario -->
            <form method="POST" action="{{ route('login') }}" class="text-left relative" novalidate>
                @csrf
    ...
    <!-- Script visor de contraseña y bloqueo mensajes nativos -->
    <script>
